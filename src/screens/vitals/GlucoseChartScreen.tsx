  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
            ...
            {glucoseData.length > 0 && (
              <View style={{ alignItems: 'flex-end' }}>
                <Text style={styles.chartSubtitle}>
                  {selectedIndex !== null ? glucoseLabels[selectedIndex] : 'Latest'}
                </Text>
                <Text style={[styles.chartTitle, { color: '#4CAF50' }]}>
                  {selectedIndex !== null 
                    ? glucoseData[selectedIndex]
                    : glucoseData[glucoseData.length - 1]} mg/dL
                </Text>
              </View>
            )}
          </View>
        ...
        {/* Statistics Card */}
        {glucoseData.length > 0 && sevenDayStats && sevenDayStats.glucose && (
          <View style={styles.statsCard}>
            <Text style={styles.statsTitle}>7-Day Statistics</Text>
            
            <View style={styles.statsGrid}>
              <View style={styles.statItem}>
                <Text style={styles.statValue}>{sevenDayStats.glucose.avg}</Text>
                <Text style={styles.statLabel}>Average</Text>
              </View>
              
              <View style={styles.statItem}>
                <Text style={styles.statValue}>{sevenDayStats.glucose.min}</Text>
                <Text style={styles.statLabel}>Minimum</Text>
              </View>
              
              <View style={styles.statItem}>
                <Text style={styles.statValue}>{sevenDayStats.glucose.max}</Text>
